...
public class TC_RF_014 extends BaseClass {
  ...
  public void VerifyAllTheMandatoryFieldsInTheRegisterAccountPageAreMarkedWithRedColorSymbol() {
	  ...
	  getDriver().findElement(By.linkText("Register")).click();
		...
		WebElement LastNameLabel = getDriver().findElement(By.cssSelector("label[for='input-lastname']"));		
		...
		WebElement EmailLabel = getDriver().findElement(By.cssSelector("label[for='input-email']"));
		...
		WebElement TelephoneLabel = getDriver().findElement(By.cssSelector("label[for='input-telephone']"));
		...
		WebElement PasswordLabel = getDriver().findElement(By.cssSelector("label[for='input-password']")); 
		...
		WebElement ConfirmPasswordLabel = getDriver().findElement(By.cssSelector("label[for='input-confirm']")); 
		...
		WebElement PrivacyPolicyLabel = getDriver().findElement(By.cssSelector("[class='pull-right']")); 
